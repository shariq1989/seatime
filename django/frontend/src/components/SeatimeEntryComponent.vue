...
<template>
  <v-app id="inspire" style="background-color: #bbdefb;">
    ...
    <v-content>
      <ConfirmModalComponent persistent v-model="logoutDialog.displayStatus" v-bind="logoutDialog"
        ...
        <v-row class="mb-6">
          ...
          <v-col cols="12" sm="10">
            ...
            <div v-if="!pageLoading">
              ...
              <div v-if="!entriesExist">
                <v-card-text>
                  No trips logged. You can log trips by clicking the "New Trip" button
                </v-card-text>
              </div>
            </div>
          </v-col>

...
DEBUG = False
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '96.126.97.44', '.seatime.work']
CORS_ORIGIN_WHITELIST = (
        'http://localhost:8080', 'http://96.126.97.44:8080', 'https://clever-hoover-e243f0.netlify.app', 'http://clever-hoover-e243f0.netlify.app'
)
